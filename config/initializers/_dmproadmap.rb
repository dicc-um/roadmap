...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.email = ENV.fetch('DMP_NAME') + ' <' + ENV.fetch('SMTP_MAIL', Rails.application.credentials.smtp_mail) + '>'
    ...
    config.x.organisation.contact_us_url = "https://" + ENV.fetch('DMPROADMAP_HOST')
